...
@RestController
@RequestMapping("/OBS_websocket")//../OBS_websocket/change_scene?scene=場景"
//http://180.177.24.44:55304/OBS_websocket
public class OBSControllAPI {
    @GetMapping("/change_scene")//../OBS_websocket/change_scene?key=&scene=場景"
    ...
    @GetMapping("/get_scenes")//../OBS_websocket/get_scenes?key=00857027@email.ntou.edu.tw"
